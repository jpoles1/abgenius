...
describe("Blood gas scenarios", () => {
	...
	test("Uncompensated Respiratory Acidosis", () => {
		...
		expect(scenario1.guessDisturbances()).toEqual([BG.DisturbType.RespAcid, BG.DisturbType.IncompleteComp]);
	});
	...
	test("Uncompensated Respiratory Alkalosis", () => {
		...
		expect(scenario1.guessDisturbances()).toEqual([BG.DisturbType.RespAlk, BG.DisturbType.IncompleteComp]);
	});
	/*
	test("Met Acidosis", () => {
